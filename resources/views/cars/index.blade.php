...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <div class="cars" >
    <h1 >Your Cars</h1>
                <div class="cars" style="background-color:rgb(243, 243, 243);">
             ...
             @foreach ($cars as $cars)
                        ...
                        <h3><b>Car Brand: {{$cars->car_brand}}</b></h3>
                        <p>Car Number: {{$cars->car_number}}</p>
                        <p>Estimated Price: {{$cars->estimated_price}}</p>
                        <p>Specifications: {{$cars->specification}}</p>
                        <p>City: {{$cars->city}}</p>
                        <p>Year: {{$cars->year}}</p>
                        <a href="{{route('cars.show', ['cars'=>$cars->id])}}" type="button" class="btn btn-success" >SHOW</a>
                        <a href="{{route('cars.update', ['cars'=>$cars->id])}}" type="button" class="btn btn-info" >UPDATE</a>
                        <a href="{{route('cars.delete', ['cars'=>$cars->id])}}" type="button" class="btn btn-danger" >DELETE</a>
                        <hr>
             @endforeach
                       </div>
                     </div>
