    ...
    <div class="container">
       ...
       <div class="row">
          <div class="col-md-8" style="background-color:rgb(236, 235, 235); padding:40px;">
           ...
           <h3 >Car Brand :  {{$cars->car_brand}}</h3>
           <h5>Car Number : {{$cars->car_number}}</h5>
           <h5 >Estimated Price : {{$cars->estimated_price}}</h5>
           <h5 >Specification : {{$cars->specification}}</h5>
           <h5 >City : {{$cars->city}}</h5>
           <h5 >Year : {{$cars->year}}</h5>
          </div>
