        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12">
                <div class="pricing-table">
                    ...
                    <div class="pricing-footer"><a href="{{route('cars.create',['pack_id'=>'1']) }}"><button  class="btn-sm btn-shadow btn-shine">Add Car</button></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-12">
                <div class="pricing-table">
                    ...
                    <div class="pricing-footer"><a href="{{route('cars.create',['pack_id'=>'2']) }}"><button class="position-relative btn-shine btn-sm btn-shadow">Add car</button></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-12">
                <div class="pricing-table featured"><span class="featured-label">Best Value</span>
                    ...
                    <div class="pricing-footer"><a href="{{route('cars.create',['pack_id'=>'3']) }}"><button class="position-relative btn-shine btn-sm btn-shadow">Add Car</button></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-12">
                <div class="pricing-table">
                    ...
                    <div class="pricing-footer"><a href="{{route('cars.create',['pack_id'=>'4']) }}"><button class="position-relative btn-shine btn-sm btn-shadow">Add Car</button></a>
                    </div>
                </div>
            </div>
        </div>
